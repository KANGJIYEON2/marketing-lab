...
**카테고리**: [revenue-impact](../README.md) · **로드맵**: Week 4 · **상태**: PRD only

## 진입점

- [`PRD.md`](./PRD.md) — 페인포인트·KPI·워크플로 다이어그램·MVP 범위
- `SETUP.md` — 구현 시 작성 예정
- `prompts/` — `lead-score-classify.md`, `welcome-email-personalized.md`, `case-study-pick.md`
- `workflows/lead-sequence.json` — n8n 임포트용 (구현 시 추가)
